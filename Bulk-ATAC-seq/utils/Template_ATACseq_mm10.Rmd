...
peakAnnoList <- lapply(c1peaks, annotatePeak, TxDb=TxDb.Mmusculus.UCSC.mm10.knownGene, annoDb="org.Mm.eg.db", tssRegion=c(-3000, 3000), verbose=FALSE)
...
peakAnnoList <- lapply(c2peaks, annotatePeak, TxDb=TxDb.Mmusculus.UCSC.mm10.knownGene, annoDb="org.Mm.eg.db", tssRegion=c(-3000, 3000), verbose=FALSE)
p1 <- plotAnnoBar(peakAnnoList)
p2 <- plotDistToTSS(peakAnnoList)
p1 / p2
```
...
if ( dim(dbins.c2.vs.c1.filtered)[1] >= 1 ) {
   ...
   peakAnnoList <- lapply(dar.list, annotatePeak, TxDb=TxDb.Mmusculus.UCSC.mm10.knownGene, annoDb="org.Mm.eg.db", tssRegion=c(-3000, 3000), verbose=FALSE)
   p1 <- plotAnnoBar(peakAnnoList)
   p2 <- plotDistToTSS(peakAnnoList)
   p1 / p2
}
